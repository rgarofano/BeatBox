...
// Written by Brian Fraser, Code style changed to match other files
...
// Prototypes
static void updateStats(timestamps_t *pData, Interval_statistics_t *pStats);
...
void Interval_getStatisticsAndClear(enum Interval_whichInterval whichInterval,
