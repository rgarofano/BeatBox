...
static unsigned char mBytes[NUM_BYTES] = {0x00, 0x50, 0x50, 0x50,
                                          0x50, 0x70, 0x70, 0x50};
...
static void displayDigits(unsigned char* buff, unsigned char* firstDigitBytes,
                          unsigned char* secondDigitBytes) {
...
static void displayInt(int number) {
  ...
  // determine which digits need to be displayed and get the bit patterns for
  // them
